...
public class GasStackRenderer implements IIngredientRenderer<GasStack> {
    ...
    private final GasStackRenderer.TooltipMode tooltipMode;
    ...
    public GasStackRenderer() {
        this(Fluid.BUCKET_VOLUME, GasStackRenderer.TooltipMode.ITEM_LIST, TEX_WIDTH, TEX_HEIGHT, null);
    }

    public GasStackRenderer(int capacityMb, boolean showCapacity, int width, int height, @Nullable IDrawable overlay) {
        this(capacityMb, showCapacity ? GasStackRenderer.TooltipMode.SHOW_AMOUNT_AND_CAPACITY : GasStackRenderer.TooltipMode.SHOW_AMOUNT, width, height, overlay);
    }

    public GasStackRenderer(int capacityMb, GasStackRenderer.TooltipMode tooltipMode, int width, int height, @Nullable IDrawable overlay) {
    ...
    public List<String> getTooltip(Minecraft minecraft, GasStack gasStack, ITooltipFlag tooltipFlag) {
        ...
        if (tooltipMode == GasStackRenderer.TooltipMode.SHOW_AMOUNT_AND_CAPACITY) {
        ...
        } else if (tooltipMode == GasStackRenderer.TooltipMode.SHOW_AMOUNT) {
